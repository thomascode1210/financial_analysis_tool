...
def investment_calculator():
    ...
    try:
        ...
        print("\n\nInvestment calculator interrupted. Returning to main menu...")
        return
...
def loan_calculator():
    ...
    try:
        ...
        print("\n\nLoan calculator interrupted. Returning to main menu...")
        return
...
def budget_analyzer():
    ...
    try:
        ...
        print("\n\nBudget analyzer interrupted. Returning to main menu...")
        return
